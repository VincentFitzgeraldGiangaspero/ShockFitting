...
#ifndef ShockFitting_ComputeStateDps4Pg3D_hh
#define ShockFitting_ComputeStateDps4Pg3D_hh
...
/// This class defines a ComputeStateDps4Pg3D, whose task is to update
...
class ComputeStateDps4Pg3D : public StateUpdater {
public:

  /// Constructor
  /// @param objectName the concrete class name
  ComputeStateDps4Pg3D(const std::string& objectName);

  /// Destructor
  ~ComputeStateDps4Pg3D();
...
private: // functions
  ...
  void Transform2Adimensional();

  void Transform2Dimensional();
...
#endif // ShockFitting_ComputeStateDps4Pg3D_hh
