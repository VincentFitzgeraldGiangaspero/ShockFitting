...
#ifndef ShockFitting_AssignShockPointState3D_hh
#define ShockFitting_AssignShockPointState3D_hh
...
/// This class define a AssignShockPointState3D, whose task is to evaluate
...
class AssignShockPointState3D {
public:

  /// Constructor
  AssignShockPointState3D();
  ...
  void extractDownstreamAndUpstreamPoints(Array3D<double> Normals_Array);
...
private: // helper functions
   ...
   /// return class name
   std::string getClassName() const { return "AssignShockPointState3D"; }
   ...
   /// assign variables used in AssignShockPointState3D to MeshData
   void setMeshData();

   /// assign variables used in AssignShockPointState3D to PhysicsData
   void setPhysicsData();
...
#endif // ShockFitting_AssignShockPointState3D_hh
