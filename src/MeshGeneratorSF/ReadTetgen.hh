...
#ifndef ShockFitting_ReadTetgen_hh
#define ShockFitting_ReadTetgen_hh
...
/// This class defines ReadTetgen, whose task is to read a Tetgen Mesh 
...
class ReadTetgen : public MeshGenerator {
public:

  /// Constructor
  /// @param objectName the concrete class name
  ReadTetgen(const std::string& objectName);
...
private: // helper functions
  ...
  /// return class name
  std::string getClassName() const {return "ReadTetgen";}
  ...
  /// get the face file name
  std::string getFaceFile() const;	// NUOVO
  ...
  /// assign values read by ReadTetgen to MeshData
  void setMeshData ();

  /// assign values read by ReadTetgen to PhysicsData
  void setPhysicsData();
...
private: // data
  ...
  /// vector characterizing faces (assignable to MeshData)
  std::vector<int>* faceptrVect;
  ...
  /// bndfac(2)(i-face) 3° endpoint of i-boundary face 		aggiunta una nuova dimensione!
  /// bndfac(3)(i-face) boundary marker of i-boundary face
  Array2D <int>* bndfac;

  /// celnod(0)(i-elem) 1° node of i-element
  /// celnod(1)(i-elem) 2° node of i-element
  /// celnod(2)(i-elem) 3° node of i-element
  /// celnod(3)(i-elem) 4° node of i-element			aggiunta una dimensione

  Array2D <int>* celnod;

  /// celcel(0)(i-elem) 1° neighbor of i-element
  /// celcel(1)(i-elem) 2° neighbor of i-element		aggiunta una dimensione
  /// celcel(2)(i-elem) 3° neighbor of i-element
  /// celcel(3)(i-elem) 4° neighbor of i-element
  Array2D <int>* celcel;
  ...
  /// faceptr(0)(i-face) 1° endpoint of i-face			aggiunta per le facce
  /// faceptr(1)(i-face) 2° endpoint of i-face
  /// faceptr(2)(i-face) 3° endpoint of i-face
  /// faceptr(3)(i-face) boundary marker of i-face
  Array2D <int>* faceptr;
  ...
  /// current number of faces			aggiunta
  unsigned m_nface;
...
#endif //ShockFitting_ReadTetgen_hh
