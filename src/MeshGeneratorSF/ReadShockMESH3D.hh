...
#ifndef ShockFitting_ReadShockMESH3D_hh
#define ShockFitting_ReadShockMESH3D_hh
...
/// This class defines ReadShockMESH3D, whose task is read data fromsh00.dat file
/// and store them in vectors and array
///

class ReadShockMESH3D : public MeshGenerator {
public:

  /// Constructor
  ReadShockMESH3D(const std::string& objectName);

  /// Destructor
  virtual ~ReadShockMESH3D();
...
private: // helper functions
  ...
  /// get class name
  std::string getClassName() const {return "ReadShockMESH3D";}
  ...
  /// assign values read and used by ReadShockMESH3D to PhysicsData
  void setPhysicsData();

  /// assign MeshData values to ReadShockMESH3D
  void setMeshData();
...
#endif //ShockFitting_ReadShockMESH3D_hh
