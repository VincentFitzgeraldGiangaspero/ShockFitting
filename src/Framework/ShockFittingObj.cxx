...
void ShockFittingObj::createMeshData()
{
  ...
  MeshData::getInstance().createData <vector<unsigned> > ("NFACE", 2);	// Aggiunto
  ...
  MeshData::getInstance().createData <vector <int> >("FACEPTR", 1);	// aggiunto
...
void ShockFittingObj::createPhysicsData()
{
  ...
  PhysicsData::getInstance().createData
  		  <vector <unsigned> > ("nShockFaces", 1);
  PhysicsData::getInstance().createData
  		  <Array3D <unsigned> > ("ShFaces", 1);

  PhysicsData::getInstance().createData
			  <vector <string> > ("TypeSpecPoints", 1);
  PhysicsData::getInstance().createData <vector <string> > ("TYPESH", 1);
  PhysicsData::getInstance().createData <Array3D <double> > ("XYZSH", 1);
  PhysicsData::getInstance().createData <Array3D <unsigned > > ("ShEDGEPoints", 1);
  PhysicsData::getInstance().createData
...
void ShockFittingObj::deletePhysicsData()
{
  ...
  PhysicsData::getInstance().deleteData <vector <unsigned> > ("nShockFaces");
  PhysicsData::getInstance().deleteData <Array3D <unsigned> > ("ShFaces");
  PhysicsData::getInstance().deleteData <vector <string> > ("TypeSpecPoints");
  PhysicsData::getInstance().deleteData <vector <string> > ("TYPESH");
  PhysicsData::getInstance().deleteData <Array3D <double> > ("XYZSH");
  PhysicsData::getInstance().deleteData <Array3D <unsigned> > ("ShEDGEPoints");
