...
//   if(m_postProHeatFlux) {m_computeHeatFlux->update();}
   ...
   cout << "_________________________________________________________________\n\n";
    ...
    execmd = "cp -f shocknor.dat sh99.dat shplt* cfout*plt cfin*plt cfout.CFmesh cfin.CFmesh na99.node " + fname->str() + ".node "

    + fname->str() + ".poly" + " debug_folder ";

	     system(execmd.c_str());

	     execmd ="mv debug_folder/"+ fname->str() + ".node " + "debug_folder/node_0.node";

	     system(execmd.c_str());

	     execmd ="mv debug_folder/"+ fname->str() + ".poly " + "debug_folder/node_0.poly";
	     system(execmd.c_str());
