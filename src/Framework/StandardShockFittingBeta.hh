...
private:
  ...
  SConfig::SharedPtr<Converter> m_createTetgenFiles;
  ...
  /// command object redistributing shock points
  SConfig::SharedPtr<Remeshing> m_smoothShockSurf;
  ...
  SConfig::SharedPtr<WritingMesh> m_writeTetgenFile;
  ...
  SConfig::SharedPtr<MeshGenerator> m_callTetgen;
  ...
  /// command object converting file format from Triangle to
  /// coolfluid format (
  SConfig::SharedPtr<Converter> m_tetgenToCFfmt;
  ...
  /// command object converting file format from CFmesh to Tetgen
  SConfig::SharedPtr<Converter> m_CFmeshToTetgen;
  ...
  SConfig::SharedPtr<WritingMesh> m_writeBackTetgenFile;
  ...
  /// command object calling CGAL library
  // SConfig::SharedPtr<ShockDetector> m_useCGAL;
