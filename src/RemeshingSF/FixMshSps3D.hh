...
#ifndef ShockFitting_FixMshSps3D_hh
#define ShockFitting_FixMshSps3D_hh
...
/// This class defines a FixMshSps3D, whose task is to fix the mesh around
/// special points.

class FixMshSps3D : public Remeshing {
public:

  /// Constructor
  /// @param objectName the concrete class name
  FixMshSps3D(const std::string& objectName);
...
private: // helper functions
  ...
  /// return class name
  std::string getClassName() const {return "FixMshSps3D";}
...
private: // data
  ...
  double xsh; double ysh; double zsh;
...
#endif // ShockFitting_FixMshSps3D_hh
