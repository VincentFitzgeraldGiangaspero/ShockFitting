...
#ifndef ShockFitting_CoPntDispl3D_hh
#define ShockFitting_CoPntDispl3D_hh
...
/// This class defines a CoPntDispl3D, whose task is to split the background
...
class CoPntDispl3D : public Remeshing {
public:


  /// Constructor
  CoPntDispl3D(const std::string& objectName);

  /// Destructor
  virtual ~CoPntDispl3D();
...
private: // helper functions
  ...
  std::string getClassName() const {return std::string("CoPntDispl3D");}
  ...
  /// assign values used in CoPntDispl3D to PhysicsData values
  void setPhysicsData();
...
#endif // ShockFitting_CoPntDispl3D_hh
