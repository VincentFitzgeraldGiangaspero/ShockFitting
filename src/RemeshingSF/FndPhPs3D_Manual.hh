...
#ifndef ShockFitting_FndPhPs3D_Manual_hh
#define ShockFitting_FndPhPs3D_Manual_hh
...
/// This class defines a FndPhPs3D_Manual, whose task is to find the cells crossed
/// by the shock and the phantom points.

class FndPhPs3D_Manual: public Remeshing {
public:

  /// Constructor
  FndPhPs3D_Manual(const std::string& objectName);

  /// Destructor
  virtual ~FndPhPs3D_Manual();
...
private: // helper functions
  ...
  /// return class name
  std::string getClassName() const {return "FndPhPs3D_Manual";}
  ...
  /// assign variables used in FndPhPs3D_Manual to MeshData
  void setMeshData();

  /// assign variables used in FndPhPs3D_Manual to PhysicsData
  void setPhysicsData();
...
#endif //ShockFitting_FndPhPs3D_Manual_hh
